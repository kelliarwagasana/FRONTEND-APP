...
export default function ListingsPage() {
  ...
  const [activeTab, setActiveTab] = useState<ExploreTab>('filters')
  ...
  const listingsData = useMemo(() => listingsQuery.data ?? [], [listingsQuery.data])
    ...
    return (
      <div className="min-h-screen bg-white text-black">
        ...
        <div className="flex min-h-[70vh] flex-col items-center justify-center gap-4 px-6">
          <Spinner />
          <p className="text-sm font-black uppercase tracking-[0.2em] text-black/55">Loading stays…</p>
        </div>
      </div>
    )
  }
    ...
    return (
      <div className="min-h-screen bg-white text-black">
        ...
        <div className="mx-auto flex min-h-[70vh] max-w-lg flex-col items-center justify-center gap-4 px-6 text-center">
          <p className="text-xl font-black text-black">Could not load listings</p>
          <p className="text-sm font-semibold text-black/55">
            {listingsQuery.error instanceof Error ? listingsQuery.error.message : 'Something went wrong'}
          </p>
          <button
            type="button"
            onClick={() => listingsQuery.refetch()}
            className=" bg-[#f97316] px-6 py-3 text-sm font-black text-white transition hover:bg-black"
          >
            Retry
          </button>
        </div>
  ...
  return (
    <div className="min-h-screen bg-white text-black">
      ...
      {listingsQuery.isFetching && !listingsQuery.isPending ? (
        <div className="pointer-events-none fixed right-5 top-24 z-[60]  bg-white/95 px-4 py-2 text-xs font-black uppercase tracking-[0.18em] text-[#f97316] shadow-lg">
          Refreshing…
        </div>
      ) : null}

      <main>
        <section className=" bg-white px-5 pb-10 pt-8">
          <div className="mx-auto max-w-7xl">
            <div className="mx-auto mb-6 flex max-w-2xl justify-center gap-2  bg-white p-1 text-xs font-black uppercase tracking-[0.14em] text-black">
              {[
          ...
          <div className="mb-8 grid gap-4  pb-6 md:grid-cols-[1fr_auto] md:items-end">
            ...
            <div className="hidden items-center gap-2 sm:flex">
              <button
                ...
                className="flex h-8 w-8 items-center justify-center  bg-white text-black disabled:opacity-40"
              >
              ...
              <button
                ...
                className="flex h-8 w-8 items-center justify-center   text-white disabled:opacity-40"
              >
          ...
          {currentPageResults.length === 0 ? (
            ...
            <div className="grid gap-x-5 gap-y-10 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
              {currentPageResults.map((result) => (
                <ListingCard
                  key={result.listing.id} listing={result.listing} 
                />
              ))}
            </div>
          )}
          ...
          {activeResults.length > pageSize && (
            <div className="mt-10 flex items-center justify-center gap-3">
              <button
                ...
                onClick={() => setCurrentPage((page) => Math.max(1, page - 1))}
                disabled={currentPage === 1}
                className=" px-5 py-2 text-sm font-black text-black transition hover:bg-[#fff7ed] disabled:cursor-not-allowed disabled:opacity-40"
              >
                Previous
              </button>
...
function AiPromptPanel({
  ...
  return (
    <div className={isCompact ? 'mx-auto max-w-2xl' : ''}>
      <div className={`flex flex-col overflow-hidden rounded-md bg-white shadow-lg md:flex-row md:items-center ${
        isCompact ? 'shadow-lg' : ''
      }`}>
...
function MapSearchPanel({
  ...
  return (
    <div className="space-y-3">
      <div className="flex flex-col overflow-hidden bg-white md:flex-row md:items-center">
      ...
      {locationStatus && (
        <p className=" border-[#f97316] bg-[#fff7ed] px-4 py-3 text-sm font-bold text-black">
          {locationStatus}
        </p>
      )}
    </div>
    ...
    <div className="space-y-4">
      ...
      <div className="mx-auto flex max-w-2xl justify-center">
        <button
          type="button"
          onClick={onClear}
          className=" bg-white px-5 py-3 text-sm font-black text-black transition hover:bg-[#fff7ed]"
        >
          Clear
        </button>
      </div>
...
function MapPreview({
  ...
  return (
    <div className="mb-8 overflow-hidden  bg-white shadow-lg">
      <div className="relative h-[28rem] overflow-hidden bg-[#fff7ed]">
        ...
        <div className="pointer-events-none absolute left-5 top-5 z-20  bg-white/95 px-5 py-4 shadow-md backdrop-blur">
        ...
        {googleMapsApiKey && (
          <div className="absolute right-5 top-5 z-20 flex  bg-white p-1 shadow-md">
        ...
        {!googleMapsApiKey && (
          <>
            <div
              className="absolute z-20 flex -translate-x-1/2 -translate-y-1/2 items-center  bg-white px-3 py-2 text-xs font-black text-black shadow-md"
            ...
            {results.map((result) => {
              ...
              return (
                <a
                  ...
                  className={`absolute z-30 flex -translate-x-1/2 -translate-y-1/2 items-center gap-2 rounded-full px-3 py-2 text-xs font-bold shadow-md transition hover:scale-105 ${
