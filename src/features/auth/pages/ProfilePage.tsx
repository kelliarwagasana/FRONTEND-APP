...
import { getCurrentUser, setCurrentUser as saveCurrentUser, subscribeToAuthChange } from '../authStorage'
import { useBecomeHost, useUpdateProfile } from '../../users/hooks'
...
export default function ProfilePage() {
    ...
    updateProfileMutation.mutate(
      {
        ...
        phone,
        avatarFile,
        removeAvatar: !avatar && !avatarFile && Boolean(currentUser.avatar),
      },
      {
        onSuccess: (user) => {
  ...
  const handleBecomeHost = () => {
    ...
    becomeHostMutation.mutate(currentUser.id, {
      onSuccess: (user) => {
        saveCurrentUser(user)
        setCurrentUser(user)
